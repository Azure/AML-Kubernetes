...
|Compute-exporter	|Collector compute level metrics	|azureml	|V0.1|	AML K8s|
|metrics-reporter 	|Upload metrics to Application Insights	|azureml	|V0.1|	AML K8s|
...
1. download [tools package](https://github.com/Azure/CMK8s-Sample/raw/master/files/tools.tar).
...
installer image: the install image, the newest image is: `mcr.microsoft.com/azureml/cmk8s/agent-setup:replace-kubeconf-06-28`
