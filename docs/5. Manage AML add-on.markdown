...
1. download [tools package](https://github.com/Azure/AML-Kubernetes/blob/master/files/tools.zip).
...
installer image: the install image, the newest image is: `mcr.microsoft.com/azureml/cmk8s/agent-setup:amlop-07-08`
