...
After you created a GPU enabled AKS cluter you can go to [attach CMAKS compute](https://github.com/Azure/CMK8s-Sample/blob/master/docs/2.%20Install%20AML%20agent%20manually.markdown).

We use AML add-on to bring your AKS cluster to AML workspace, if you want to know more detail about AML add-on, please goto [managed AML add-on](https://github.com/Azure/CMK8s-Sample/blob/master/docs\5. Manage AML add-on.markdown)